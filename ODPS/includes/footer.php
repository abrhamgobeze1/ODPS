...
<footer class="bg-dark text-white py-5">
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4 mb-md-0">
                <h5 class="text-uppercase font-weight-bold mb-4 text-primary">About Us</h5>
                <p class="text-muted">The Online Dormitory Placement System is a comprehensive platform that helps
                    manage the dormitory placement process for students. We strive to provide efficient and secure
                    services to the students of our university.</p>
            </div>
            <div class="col-md-4 mb-4 mb-md-0">
            ...
            <div class="col-md-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><i class="fas fa-phone mr-3 text-primary"></i>+251 923-3650-46</li>
    ...
    <div class="container-fluid bg-darker-dark py-3 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class="mb-0 text-muted">&copy; <span id="date-time"></span> Online Dormitory Placement System.

...
// Fetch proctors
$sql_proctors = "SELECT p.proctor_id, p.username, p.name, p.contact_number, b.block_name 
                FROM proctor p
...
$sql_blocks = "SELECT block_id, block_name FROM blocks";
                ...
                <tbody>
                    <?php foreach ($proctors as $proctor) : ?>
                        <tr>
                            ...
                            <td><?php echo $proctor['block_name']; ?></td>
                            <td>

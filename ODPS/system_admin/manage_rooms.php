...
$sql_rooms = "SELECT r.room_id, r.room_number, r.room_description, r.room_facilities, r.room_capacity, r.room_availability, b.block_name FROM rooms r INNER JOIN blocks b ON r.block_id = b.block_id LIMIT ?, ?";
...
if ($result_blocks) {
    ...
    echo "Error fetching blocks: " . $conn->error; // Output error message
    $blocks = []; // Set blocks array to empty
}
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="block_id" name="block_id" required>
                                                <option value="">Select Block</option>
                                                <?php foreach ($blocks as $block): ?>
                                                    <option value="<?php echo $block['block_id']; ?>" <?php if ($block['block_id'] == $room['block_id'])
                                                           echo 'selected'; ?>>
                                                        <?php echo $block['block_name']; ?></option>
                                                <?php endforeach; ?>
                                            </select>

...
$sql_beds = "SELECT b.bed_id, b.bed_number, r.room_number, r.room_description FROM beds b INNER JOIN rooms r ON b.room_id = r.room_id LIMIT ?, ?";
...
$sql_count = "SELECT COUNT(*) AS total FROM beds";
...
if ($result_rooms) {
    ...
    echo "Error fetching rooms: " . $conn->error; // Output error message
    $rooms = []; // Set rooms array to empty
}

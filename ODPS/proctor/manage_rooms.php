...
// Fetch rooms and blocks assigned to the proctor
...
$sql_rooms = "SELECT r.room_id, r.room_number, r.room_description, r.room_facilities, r.room_capacity, r.room_availability, b.block_name 
              ...
              WHERE r.block_id = $proctor_block_id";
$result_rooms = $conn->query($sql_rooms);
$rooms = $result_rooms->fetch_all(MYSQLI_ASSOC);

$sql_blocks = "SELECT * FROM blocks WHERE block_id = $proctor_block_id";
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Availability:
                                    <?php echo $room['room_availability'] ? 'Available' : 'Not Available'; ?>
                                </p>
